...
import speech_recognition as sr  #computer speech recognion, or speech-to-text, is a capability which enables 
import webbrowser
import datetime
import os
import wikipedia
...
def wishme():
   ...
   if hour>=0 and hour<12:
      ...
      speak("Good evening ")
   speak("I am Machine sir. pelase tell me how can i help you")
...
def emailSend(to,content):
   ...
   server.ehlo()
   server.starttls()
   server.login('g4gaurav892001@gmail.com', '')
...
if __name__ == '__main__':
    ...
    while True:
      ...
      if 'wikipedia' in query:
         ...
         os.startfile(os.path.join(vedio_dir, vedio[0]))   
         ...
         codepath="C:\\Program Files\\JetBrains\\PyCharm Community Edition 2019.3.3\\bin"
         os.startfile(codepath)
